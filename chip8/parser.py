...
# A "syntax tree" (for lack of a better name) of the CHIP-8 opcode language.
...
_syntax = {
    0x0: {
        0x0: {0xE: {0x0: 0x00E0, 0xE: 0x00EE}, "any": {"any": 0x0000}},
        "any": 0x0000,
    },
    0x1: 0x1000,
    0x2: 0x2000,
    ...
    0xC: 0xC000,
    0xD: 0xD000,
    0xE: {"any": {0x9: 0xE09E, 0xA: 0xE0A1}},
    0xF: {
        "any": {
            0x0: {0x7: 0xF007, 0xA: 0xF00A},
            0x1: {0x5: 0xF015, 0x8: 0xF018, 0xE: 0xF01E},
            0x2: 0xF029,
            0x3: 0xF033,
            0x5: 0xF055,
            0x6: 0xF065,
...
def search_opcode(instruction: int) -> int:
...
class ParsedInstruction(object):
    ...
    def __init__(self, uint16: int):
        self.bytes = uint16
        self.opcode: int = search_opcode(uint16)
        self.nnn = uint16 & 0b0000_1111_1111_1111
        self.n = uint16 & 0b0000_0000_0000_1111
        self.x = (uint16 & 0b0000_1111_0000_0000) >> 8
        self.y = (uint16 & 0b0000_0000_1111_0000) >> 4
        self.kk = uint16 & 0b0000_0000_1111_1111
...
def parse_file(filename: str) -> List[ParsedInstruction]:
    ret = []
